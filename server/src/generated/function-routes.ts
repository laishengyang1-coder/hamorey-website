...
import * as route6 from '../../../functions/api/admin/operation-logs.ts';
import * as route7 from '../../../functions/api/admin/organizations.ts';
import * as route8 from '../../../functions/api/admin/organizations/[id].ts';
import * as route9 from '../../../functions/api/admin/partner-leads.ts';
import * as route10 from '../../../functions/api/admin/partner-leads/[id].ts';
import * as route11 from '../../../functions/api/admin/points-ledger.ts';
import * as route12 from '../../../functions/api/admin/points-ledger/adjust.ts';
import * as route13 from '../../../functions/api/admin/points-rules.ts';
import * as route14 from '../../../functions/api/admin/points-rules/[id].ts';
import * as route15 from '../../../functions/api/admin/product-models.ts';
import * as route16 from '../../../functions/api/admin/product-models/[id].ts';
import * as route17 from '../../../functions/api/admin/products.ts';
import * as route18 from '../../../functions/api/admin/rebate-rules.ts';
import * as route19 from '../../../functions/api/admin/rebate-rules/[id].ts';
import * as route20 from '../../../functions/api/admin/redemptions.ts';
import * as route21 from '../../../functions/api/admin/redemptions/[id]/approve.ts';
import * as route22 from '../../../functions/api/admin/redemptions/[id]/reject.ts';
import * as route23 from '../../../functions/api/admin/redemptions/[id]/ship.ts';
import * as route24 from '../../../functions/api/admin/reviews-[id].ts';
import * as route25 from '../../../functions/api/admin/reviews.ts';
import * as route26 from '../../../functions/api/admin/reviews/[id].ts';
import * as route27 from '../../../functions/api/admin/reviews/[id]/approve.ts';
import * as route28 from '../../../functions/api/admin/reviews/[id]/reject.ts';
import * as route29 from '../../../functions/api/admin/rewards.ts';
import * as route30 from '../../../functions/api/admin/rewards/[id].ts';
import * as route31 from '../../../functions/api/admin/store-public-profiles.ts';
import * as route32 from '../../../functions/api/admin/store-public-profiles/[id].ts';
import * as route33 from '../../../functions/api/admin/store-public.ts';
import * as route34 from '../../../functions/api/admin/system-settings.ts';
import * as route35 from '../../../functions/api/admin/system-settings/[id].ts';
import * as route36 from '../../../functions/api/admin/upload-url.ts';
import * as route37 from '../../../functions/api/admin/users.ts';
import * as route38 from '../../../functions/api/admin/warranty-codes-allocate.ts';
import * as route39 from '../../../functions/api/admin/warranty-codes-import.ts';
import * as route40 from '../../../functions/api/admin/warranty-codes-revoke.ts';
import * as route41 from '../../../functions/api/admin/warranty-codes.ts';
import * as route42 from '../../../functions/api/admin/warranty-codes/allocate.ts';
import * as route43 from '../../../functions/api/admin/warranty-codes/import.ts';
import * as route44 from '../../../functions/api/admin/warranty-codes/revoke.ts';
import * as route45 from '../../../functions/api/admin/warranty-record-list.ts';
import * as route46 from '../../../functions/api/admin/warranty-records-[id].ts';
import * as route47 from '../../../functions/api/admin/warranty-records-create.ts';
import * as route48 from '../../../functions/api/admin/warranty-records.ts';
import * as route49 from '../../../functions/api/admin/warranty-records/[id].ts';
import * as route50 from '../../../functions/api/auth/login.ts';
import * as route51 from '../../../functions/api/auth/logout.ts';
import * as route52 from '../../../functions/api/auth/me.ts';
import * as route53 from '../../../functions/api/contact.ts';
import * as route54 from '../../../functions/api/health.ts';
import * as route55 from '../../../functions/api/partner-leads.ts';
import * as route56 from '../../../functions/api/province/account.ts';
import * as route57 from '../../../functions/api/province/addresses.ts';
import * as route58 from '../../../functions/api/province/addresses/[id].ts';
import * as route59 from '../../../functions/api/province/dashboard.ts';
import * as route60 from '../../../functions/api/province/organizations.ts';
import * as route61 from '../../../functions/api/province/organizations/[id].ts';
import * as route62 from '../../../functions/api/province/points.ts';
import * as route63 from '../../../functions/api/province/redemptions.ts';
import * as route64 from '../../../functions/api/province/rewards.ts';
import * as route65 from '../../../functions/api/province/warranty-codes.ts';
import * as route66 from '../../../functions/api/province/warranty-codes/allocate.ts';
import * as route67 from '../../../functions/api/province/warranty-records-[id].ts';
import * as route68 from '../../../functions/api/province/warranty-records.ts';
import * as route69 from '../../../functions/api/province/warranty-records/[id].ts';
import * as route70 from '../../../functions/api/public/certificates.ts';
import * as route71 from '../../../functions/api/public/certificates/[[path]].ts';
import * as route72 from '../../../functions/api/public/claim-prices.ts';
import * as route73 from '../../../functions/api/public/photos/[[path]].ts';
import * as route74 from '../../../functions/api/public/warranties.ts';
import * as route75 from '../../../functions/api/r2-upload/[[path]].ts';
import * as route76 from '../../../functions/api/store/account.ts';
import * as route77 from '../../../functions/api/store/addresses.ts';
import * as route78 from '../../../functions/api/store/addresses/[id].ts';
import * as route79 from '../../../functions/api/store/dashboard.ts';
import * as route80 from '../../../functions/api/store/points.ts';
import * as route81 from '../../../functions/api/store/redemptions.ts';
import * as route82 from '../../../functions/api/store/rewards.ts';
import * as route83 from '../../../functions/api/store/upload-url.ts';
import * as route84 from '../../../functions/api/store/warranty-codes.ts';
import * as route85 from '../../../functions/api/store/warranty-records-[id].ts';
import * as route86 from '../../../functions/api/store/warranty-records.ts';
import * as route87 from '../../../functions/api/store/warranty-records/[id].ts';
import * as route88 from '../../../functions/api/stores.ts';
import * as route89 from '../../../functions/api/warranty-search.ts';
