...
import * as route2 from '../../../functions/api/admin/code-allocations.ts';
import * as route3 from '../../../functions/api/admin/content-entries.ts';
import * as route4 from '../../../functions/api/admin/dashboard.ts';
import * as route5 from '../../../functions/api/admin/exports.ts';
import * as route6 from '../../../functions/api/admin/film-exchange-[id].ts';
import * as route7 from '../../../functions/api/admin/film-exchange.ts';
import * as route8 from '../../../functions/api/admin/film-exchange/[id].ts';
import * as route9 from '../../../functions/api/admin/film-exchange/[id]/approve.ts';
import * as route10 from '../../../functions/api/admin/film-exchange/[id]/complete.ts';
import * as route11 from '../../../functions/api/admin/film-exchange/[id]/reject.ts';
import * as route12 from '../../../functions/api/admin/film-exchange/[id]/ship.ts';
import * as route13 from '../../../functions/api/admin/operation-logs.ts';
import * as route14 from '../../../functions/api/admin/organizations.ts';
import * as route15 from '../../../functions/api/admin/organizations/[id].ts';
import * as route16 from '../../../functions/api/admin/partner-leads.ts';
import * as route17 from '../../../functions/api/admin/partner-leads/[id].ts';
import * as route18 from '../../../functions/api/admin/points-ledger.ts';
import * as route19 from '../../../functions/api/admin/points-ledger/adjust.ts';
import * as route20 from '../../../functions/api/admin/points-rules.ts';
import * as route21 from '../../../functions/api/admin/points-rules/[id].ts';
import * as route22 from '../../../functions/api/admin/product-models.ts';
import * as route23 from '../../../functions/api/admin/product-models/[id].ts';
import * as route24 from '../../../functions/api/admin/products.ts';
import * as route25 from '../../../functions/api/admin/rebate-rules.ts';
import * as route26 from '../../../functions/api/admin/rebate-rules/[id].ts';
import * as route27 from '../../../functions/api/admin/redemptions.ts';
import * as route28 from '../../../functions/api/admin/redemptions/[id]/approve.ts';
import * as route29 from '../../../functions/api/admin/redemptions/[id]/reject.ts';
import * as route30 from '../../../functions/api/admin/redemptions/[id]/ship.ts';
import * as route31 from '../../../functions/api/admin/reviews-[id].ts';
import * as route32 from '../../../functions/api/admin/reviews.ts';
import * as route33 from '../../../functions/api/admin/reviews/[id].ts';
import * as route34 from '../../../functions/api/admin/reviews/[id]/approve.ts';
import * as route35 from '../../../functions/api/admin/reviews/[id]/reject.ts';
import * as route36 from '../../../functions/api/admin/rewards.ts';
import * as route37 from '../../../functions/api/admin/rewards/[id].ts';
import * as route38 from '../../../functions/api/admin/star-plan.ts';
import * as route39 from '../../../functions/api/admin/store-public-profiles.ts';
import * as route40 from '../../../functions/api/admin/store-public-profiles/[id].ts';
import * as route41 from '../../../functions/api/admin/store-public.ts';
import * as route42 from '../../../functions/api/admin/system-settings.ts';
import * as route43 from '../../../functions/api/admin/system-settings/[id].ts';
import * as route44 from '../../../functions/api/admin/upload-url.ts';
import * as route45 from '../../../functions/api/admin/users.ts';
import * as route46 from '../../../functions/api/admin/warranty-codes-allocate.ts';
import * as route47 from '../../../functions/api/admin/warranty-codes-import.ts';
import * as route48 from '../../../functions/api/admin/warranty-codes-revoke.ts';
import * as route49 from '../../../functions/api/admin/warranty-codes.ts';
import * as route50 from '../../../functions/api/admin/warranty-codes/allocate.ts';
import * as route51 from '../../../functions/api/admin/warranty-codes/import.ts';
import * as route52 from '../../../functions/api/admin/warranty-codes/revoke.ts';
import * as route53 from '../../../functions/api/admin/warranty-record-list.ts';
import * as route54 from '../../../functions/api/admin/warranty-records-[id].ts';
import * as route55 from '../../../functions/api/admin/warranty-records-create.ts';
import * as route56 from '../../../functions/api/admin/warranty-records.ts';
import * as route57 from '../../../functions/api/admin/warranty-records/[id].ts';
import * as route58 from '../../../functions/api/auth/login.ts';
import * as route59 from '../../../functions/api/auth/logout.ts';
import * as route60 from '../../../functions/api/auth/me.ts';
import * as route61 from '../../../functions/api/contact.ts';
import * as route62 from '../../../functions/api/health.ts';
import * as route63 from '../../../functions/api/partner-leads.ts';
import * as route64 from '../../../functions/api/province/account.ts';
import * as route65 from '../../../functions/api/province/addresses.ts';
import * as route66 from '../../../functions/api/province/addresses/[id].ts';
import * as route67 from '../../../functions/api/province/dashboard.ts';
import * as route68 from '../../../functions/api/province/organizations.ts';
import * as route69 from '../../../functions/api/province/organizations/[id].ts';
import * as route70 from '../../../functions/api/province/points.ts';
import * as route71 from '../../../functions/api/province/redemptions.ts';
import * as route72 from '../../../functions/api/province/rewards.ts';
import * as route73 from '../../../functions/api/province/upload-url.ts';
import * as route74 from '../../../functions/api/province/warranty-codes.ts';
import * as route75 from '../../../functions/api/province/warranty-codes/allocate.ts';
import * as route76 from '../../../functions/api/province/warranty-records-[id].ts';
import * as route77 from '../../../functions/api/province/warranty-records.ts';
import * as route78 from '../../../functions/api/province/warranty-records/[id].ts';
import * as route79 from '../../../functions/api/public/certificates.ts';
import * as route80 from '../../../functions/api/public/certificates/[[path]].ts';
import * as route81 from '../../../functions/api/public/claim-prices.ts';
import * as route82 from '../../../functions/api/public/photos/[[path]].ts';
import * as route83 from '../../../functions/api/public/warranties.ts';
import * as route84 from '../../../functions/api/r2-upload/[[path]].ts';
import * as route85 from '../../../functions/api/store/account.ts';
import * as route86 from '../../../functions/api/store/addresses.ts';
import * as route87 from '../../../functions/api/store/addresses/[id].ts';
import * as route88 from '../../../functions/api/store/dashboard.ts';
import * as route89 from '../../../functions/api/store/film-exchange-media-url.ts';
import * as route90 from '../../../functions/api/store/film-exchange.ts';
import * as route91 from '../../../functions/api/store/points.ts';
import * as route92 from '../../../functions/api/store/redemptions.ts';
import * as route93 from '../../../functions/api/store/rewards.ts';
import * as route94 from '../../../functions/api/store/upload-url.ts';
import * as route95 from '../../../functions/api/store/warranty-codes.ts';
import * as route96 from '../../../functions/api/store/warranty-lookup.ts';
import * as route97 from '../../../functions/api/store/warranty-records-[id].ts';
import * as route98 from '../../../functions/api/store/warranty-records.ts';
import * as route99 from '../../../functions/api/store/warranty-records/[id].ts';
import * as route100 from '../../../functions/api/stores.ts';
import * as route101 from '../../../functions/api/warranty-search.ts';
...
export const functionRoutes: FunctionRouteDefinition[] = [
  {
    path: "/api/admin/film-exchange/:id/approve",
    score: 144,
    segments: [{"kind":"static","value":"admin"},{"kind":"static","value":"film-exchange"},{"kind":"param","name":"id"},{"kind":"static","value":"approve"}],
    module: route9,
  },
  {
    path: "/api/admin/film-exchange/:id/complete",
    score: 144,
    segments: [{"kind":"static","value":"admin"},{"kind":"static","value":"film-exchange"},{"kind":"param","name":"id"},{"kind":"static","value":"complete"}],
    module: route10,
  },
  {
    path: "/api/admin/film-exchange/:id/reject",
    score: 144,
    segments: [{"kind":"static","value":"admin"},{"kind":"static","value":"film-exchange"},{"kind":"param","name":"id"},{"kind":"static","value":"reject"}],
    module: route11,
  },
  {
    path: "/api/admin/film-exchange/:id/ship",
    score: 144,
    segments: [{"kind":"static","value":"admin"},{"kind":"static","value":"film-exchange"},{"kind":"param","name":"id"},{"kind":"static","value":"ship"}],
    module: route12,
  },
  {
  ...
  {
    path: "/api/admin/film-exchange/:id",
    score: 103,
    segments: [{"kind":"static","value":"admin"},{"kind":"static","value":"film-exchange"},{"kind":"param","name":"id"}],
    module: route8,
  },
  {
  ...
  {
    path: "/api/admin/code-allocations",
    score: 82,
    segments: [{"kind":"static","value":"admin"},{"kind":"static","value":"code-allocations"}],
    module: route2,
  },
  {
  ...
  {
    path: "/api/admin/film-exchange",
    score: 82,
    segments: [{"kind":"static","value":"admin"},{"kind":"static","value":"film-exchange"}],
    module: route7,
  },
  {
  ...
  {
    path: "/api/admin/star-plan",
    score: 82,
    segments: [{"kind":"static","value":"admin"},{"kind":"static","value":"star-plan"}],
    module: route38,
  },
  {
  ...
  {
    path: "/api/province/upload-url",
    score: 82,
    segments: [{"kind":"static","value":"province"},{"kind":"static","value":"upload-url"}],
    module: route73,
  },
  {
  ...
  {
    path: "/api/store/film-exchange",
    score: 82,
    segments: [{"kind":"static","value":"store"},{"kind":"static","value":"film-exchange"}],
    module: route90,
  },
  {
    path: "/api/store/film-exchange-media-url",
    score: 82,
    segments: [{"kind":"static","value":"store"},{"kind":"static","value":"film-exchange-media-url"}],
    module: route89,
  },
  {
  ...
  {
    path: "/api/store/warranty-lookup",
    score: 82,
    segments: [{"kind":"static","value":"store"},{"kind":"static","value":"warranty-lookup"}],
    module: route96,
  },
  {
  ...
  },
  {
    path: "/api/admin/film-exchange-:id",
    score: 72,
    segments: [{"kind":"static","value":"admin"},{"kind":"embeddedParam","prefix":"film-exchange-","name":"id","suffix":""}],
    module: route6,
  },
  {
    path: "/api/admin/reviews-:id",
