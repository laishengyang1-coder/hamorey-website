// ============================================================
// POST /api/province/upload-url — 获取 R2 直传预签名 URL（省代代门店登记质保时上传施工照片）
// ============================================================
...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  try {
    ...
    if (!user || user.role !== 'PROVINCE') return error('无权上传施工照片', 403);
    ...
    console.error('[province/upload-url]', err);
