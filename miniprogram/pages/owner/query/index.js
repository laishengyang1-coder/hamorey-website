...
const HOME_CONFIG = {
  banners: [
    {
      image: 'http://134.175.187.12/images/home-bg.jpg',
      title: '和膜 HAMOREY',
      subtitle: '高端汽车膜 · 守护每一程',
      tag: '品牌旗舰'
    },
    {
      image: 'http://134.175.187.12/images/home-bg-1.jpg',
      title: '隐形车衣',
      subtitle: '漆面保护膜 · 自愈抗污',
      tag: 'PPF'
    },
    {
      image: 'http://134.175.187.12/images/home-bg-2.jpg',
      title: 'TPU 改色膜',
      subtitle: '色彩随心 · 保护随行',
      tag: 'COLOR'
    },
    {
      image: 'http://134.175.187.12/images/home-bg-3.jpg',
      title: '全车窗膜',
      subtitle: '隔热防晒 · 清晰视野',
      tag: 'WINDOW'
    }
  ...
  functions: [
    {
      ...
      icon: 'http://134.175.187.12/images/icon-warranty.png',
    ...
    },
    {
      ...
      icon: 'http://134.175.187.12/images/icon-login.png',
    ...
    },
    {
      ...
      icon: 'http://134.175.187.12/images/icon-terms.png',
    ...
    },
    {
      ...
      icon: 'http://134.175.187.12/images/icon-quote.png',
      page: '/pages/owner/quote/index'
    }
  ],
  cases: [
    {
      image: 'http://134.175.187.12/images/cases/color-ppf/10001.jpg',
      title: 'TPU 改色 · 电光金属灰',
      desc: '质感出众 · 个性定制'
    },
    {
      image: 'http://134.175.187.12/images/cases/color-ppf/10005.jpg',
      title: 'TPU 改色 · 液态金属银',
      desc: '色彩饱满 · 保护随行'
    },
    {
      image: 'http://134.175.187.12/images/cases/color-ppf/10010.jpg',
      title: 'TPU 改色 · 哑光战斗灰',
      desc: '高级哑光 · 耐久如新'
    }
  ],
  productSeries: [
    {
      ...
      desc: '隔热·防晒·隐私',
      image: 'http://134.175.187.12/images/prod-window.png'
    },
    {
      key: 'ppf',
      title: '隐形车衣',
      ...
      desc: '抗划痕·自修复',
      image: 'http://134.175.187.12/images/prod-ppf.png'
    },
    {
      key: 'color',
      title: 'TPU 改色膜',
      subtitle: 'COLOR WRAP',
      desc: '色彩·保护·耐久',
      image: 'http://134.175.187.12/images/prod-color.png'
    },
    {
      key: 'roof',
      title: '天窗冰甲',
      subtitle: 'ROOF ARMOR',
      desc: '降温·防爆·隔热',
      image: 'http://134.175.187.12/images/prod-sunroof.png'
    }
  ],
  brand: {
    title: '和膜 HAMOREY',
    subtitle: 'BRAND INTRODUCTION',
    image: 'http://134.175.187.12/images/logo.png',
    paragraphs: [
