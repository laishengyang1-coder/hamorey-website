  ...
  return (
    <div>
      ...
      <div className="mt-6 bg-white rounded-xl border border-gray-100 p-6 max-w-lg">
        ...
        <button onClick={handleExport} disabled={loading} className="w-full rounded-lg bg-gray-900 py-2.5 text-sm font-medium text-white hover:bg-gray-800 disabled:opacity-50">
          {loading ? '导出中...' : '生成导出文件'}
        </button>
