    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-lg bg-[#5C1A1A] mb-4">
            <span className="text-white text-xl font-bold">省</span>
          </div>
          <h1 className="text-xl font-semibold text-gray-900">省代管理中心</h1>
          <p className="mt-1 text-sm text-gray-500">请使用省代账号登录</p>
        </div>
